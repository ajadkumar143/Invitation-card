...
const HaldiPage = () => {
  return (
    <div className="w-full h-full relative bg-yellow-50 flex flex-col items-center justify-center overflow-hidden">
      ...
      >
        <span className="text-orange-600 uppercase tracking-[0.2em] text-xs font-bold mb-2">The Golden Glow</span>
        <h1 className="font-serif text-5xl text-orange-600 mb-6 drop-shadow-sm">Haldi Ceremony</h1>
        ...
        <div className="bg-white/70 backdrop-blur-md p-6 rounded-3xl shadow-xl border border-yellow-200/50 w-full max-w-[300px] flex flex-col gap-4">
          ...
          <div>
            ...
            <p className="text-neutral-700 text-sm font-medium">Dhaurahara, Varanasi 221104</p>
          </div>
